...
public class OverviewTabsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overview_tabs);
        mFinishBtn=(Button)findViewById(R.id.intro_btn_finish);
        mNextBtn=(ImageView) findViewById(R.id.intro_btn_next);
        ...
        final int color2 = ContextCompat.getColor(this, R.color.indigo);
        ...
        mFinishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utils.saveSharedSetting(OverviewTabsActivity.this, SplashActivity.PREF_USER_FIRST_TIME, "false");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overview_tabs, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_overview_tabs, container, false);
